...
# Generate a list with random numbers ensuring 24 is included
numbers = random.sample(range(1, 100), 19) + [24]
...
def on_draw():
    ...
    for i, number in enumerate(numbers):
        ...
        if i == current_index and not search_complete:
            color = (255, 0, 255)  # Magenta for the current box being checked
        elif i == found_index:
            color = (0, 0, 255)  # Blue if 24 is found
        else:
